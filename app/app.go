...
func New(
	...
	app.MitoblockchainKeeper = *mitoblockchainmodulekeeper.NewKeeper(
		...
		keys[mitoblockchainmoduletypes.MemStoreKey],
		app.GetSubspace(mitoblockchainmoduletypes.ModuleName),
	)
	mitoblockchainModule := mitoblockchainmodule.NewAppModule(appCodec, app.MitoblockchainKeeper, app.AccountKeeper, app.BankKeeper)
