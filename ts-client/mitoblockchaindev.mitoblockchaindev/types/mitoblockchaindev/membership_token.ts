...
const baseMembershipToken: object = {
  creator: "",
  id: 0,
  timestamp: "",
  activityName: "",
...
export const MembershipToken = {
  encode(message: MembershipToken, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
    ...
    if (message.membershipDuration !== "") {
      writer.uint32(58).string(message.membershipDuration);
    }
  ...
  decode(input: Reader | Uint8Array, length?: number): MembershipToken {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMembershipToken } as MembershipToken;
  ...
  fromJSON(object: any): MembershipToken {
    const message = { ...baseMembershipToken } as MembershipToken;
  ...
  toJSON(message: MembershipToken): unknown {
    const obj: any = {};
  ...
  fromPartial(object: DeepPartial<MembershipToken>): MembershipToken {
    const message = { ...baseMembershipToken } as MembershipToken;
    if (object.creator !== undefined && object.creator !== null) {
