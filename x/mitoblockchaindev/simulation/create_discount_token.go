...
func SimulateMsgCreateDiscountToken(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		// TODO: Handling the CreateDiscountToken simulation

		return simtypes.NoOpMsg(types.ModuleName, msg.Type(), "CreateDiscountToken simulation not implemented"), nil, nil
	}
}
